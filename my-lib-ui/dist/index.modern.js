...
var Empty = function Empty() {
  ...
  })), React.createElement("div", null, React.createElement("span", null, "Aucune donn\xE9e disponible")));
};
var TableComponent = function TableComponent(props) {
  var dataSource = props.dataSource,
    ...
    empty = _props$empty === void 0 ? React.createElement(Empty, null) : _props$empty;
  var _useState = useState([]),
    show = _useState[0],
    setShow = _useState[1];
  ...
  return React.createElement("div", {
  ...
  }))), React.createElement("tbody", null, show.map(function (data, index) {
  ...
  }, empty), pagination && dataSource.length > 0 && React.createElement("div", {
    className: 'component-ui-table-pagin'
  }, React.createElement(Pagin, {
    value: React.createElement("span", null, React.createElement("svg", {
      xmlns: 'http://www.w3.org/2000/svg',
      width: '16',
      height: '16',
      fill: 'currentColor',
    ...
    return React.createElement(Pagin, {
      value: p,
      onClick: function onClick() {
        return setPage(p);
      },
