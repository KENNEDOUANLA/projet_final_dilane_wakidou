import React, { useState, useEffect as useEffect$1 } from 'react';
...
var SelectComponent = function SelectComponent(props) {
  ...
  }, selected)), React.createElement("div", null, React.createElement("svg", {
...
var $defineProperties = function defineProperties(O, Properties) {
  ...
  $forEach$1(keys, function (key) {
    if (!descriptors || functionCall($propertyIsEnumerable$2, properties, key)) $defineProperty$1(O, key, properties[key]);
  });
  return O;
};
...
if (!symbolConstructorDetection) {
  ...
  if (descriptors) {
    ...
    {
      defineBuiltIn(ObjectPrototype$1, 'propertyIsEnumerable', $propertyIsEnumerable$2, { unsafe: true });
    }
  }
}
...
if (descriptors && isCallable(NativeSymbol) && (!('description' in SymbolPrototype$1) ||
  ...
  defineProperty$7(SymbolPrototype$1, 'description', {
    configurable: true,
    get: function description() {
...
var TableComponent = function TableComponent(props) {
  ...
  return React.createElement("div", null, React.createElement("table", null, React.createElement("thead", null), React.createElement("tbody", null)));
};

export { ButtonComponent, CheckboxComponent, InputComponent, RadioComponent, SelectComponent, TableComponent };
