      ...
      inscriptionRequest(user)
        .then((res) => {
          ...
          api.info({
            ...
            description:
              "Votre compte sera être examiné par un admin avant validation",
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.headerImg}>
        <p>
          ▷ Depuis 2008, RIDE, agence de location de voitures de luxe propose
          ses services partout en France (Paris, Monaco, Nice, Cannes,
          Saint-Tropez, Courchevel, Saint-Moritz...).Notre expérience est à
          votre service pour répondre à toutes vos demandes
        </p>
      </div>
        ...
        <form className={styles.formDiv}>
          ...
          <div className={styles.formDivInputsDiv}>
            ...
            <InputComponent
              ...
              value={user.subName}
              onChange={(e: any) =>
                setUser({ ...user, subName: e.target.value })
              }
            />
            <InputComponent
              type="email"
            ...
            <SelectComponent
              ...
              data={data}
              value={user.nation}
              onSelected={(value: any) => setUser({ ...user, nation: value })}
            />
          </div>
          <div>
            <CheckboxComponent
              ...
              onChange={(e: any) =>
                setUser({ ...user, acceptCondi: e.target.checked })
              }
            />
          </div>
